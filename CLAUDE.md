...
- **A harness verifies; it never does the work.** `tools/importloop/` decides whether an import is faithful and never writes content. A harness that produced the thing it grades cannot grade it.
