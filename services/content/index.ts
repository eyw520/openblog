...
import { parseEntry, type Entry, type EntryMeta } from "@/lib/content/entry";
import { sortEntries } from "@/lib/content/sort";

/**
 * Reading content/ from disk at build time. This module is deliberately thin:
 * it finds files and hands their contents to the pure functions in lib/content,
 * which own every rule. Nothing here runs in a browser — `server-only` makes
